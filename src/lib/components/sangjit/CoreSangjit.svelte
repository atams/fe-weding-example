<script lang="ts">
    ...
    const packages = [
        {
            title: "Tingjing Package",
            subtitle: "Suitable for simple Engagement",
            price: "Rp5,000,000",
            image: "/img/sangjit.jpg",
            bgColor: "bg-white",
        },
        {
            title: "Sangjit Basic Package",
        ...
        {
            title: "Sangjit Full Package",
            subtitle:
                "Specially crafted for exclusive & full sangjit experience!",
            price: "Rp21,000,000",
            image: "/img/sangjit.jpg",
